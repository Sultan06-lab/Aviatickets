...
export { angle, bounce, branch, center, circular, clamp, clip, cosine, createNearestLookup, cubic, difference, distance, exponential, fit, fraction, inverse, isUnit, linear, mapFrom, mapRange, mapTo, maximum, minimum, mix, multiply, offset, peak, quadratic, quantize, quartic, quintic, radial, radiansToUnit, repeat, round, sine, subdivision, threshold, toIndex, toggle, triangle, unitMax, unitMin, wrap };
